...
const THEMES = {
  dawn: {
    midnight:'#1a0a1a', deep:'#2d1a2d', void:'#3d2040', card:'#f0e6f0',
    border:'rgba(180,120,160,0.2)', text:'#2d1a2d', muted:'rgba(45,26,45,0.5)',
    bg:'linear-gradient(160deg,#f5d6e8 0%,#e8c4d8 30%,#d4a0c0 60%,#c490b0 100%)',
    gold:'#c9a96e', gold2:'#e8cc9a', rose:'#c97b9a', sky:'#7ba8c9',
    glow:'rgba(201,169,110,0.15)', label:'🌸 Dawn',
    bubbleAi:'rgba(255,255,255,0.7)', bubbleUser:'rgba(45,26,45,0.15)',
    headerBg:'rgba(250,230,240,0.9)',
  },
  morning: {
    midnight:'#faf6f0', deep:'#f5ede0', void:'#ede0d0', card:'#fff8f0',
    border:'rgba(180,140,100,0.15)', text:'#2c1810', muted:'rgba(44,24,16,0.45)',
    bg:'linear-gradient(160deg,#fdf6ec 0%,#f5e6d0 40%,#ede0c8 70%,#e8d8c0 100%)',
    gold:'#b8843a', gold2:'#d4a060', rose:'#c06080', sky:'#5080a0',
    glow:'rgba(184,132,58,0.12)', label:'☀️ Morning',
    bubbleAi:'rgba(255,255,255,0.85)', bubbleUser:'rgba(44,24,16,0.08)',
    headerBg:'rgba(253,246,236,0.95)',
  },
  evening: {
    midnight:'#1a0f05', deep:'#2a1a08', void:'#3a2510', card:'#2d1f0a',
    border:'rgba(220,160,80,0.2)', text:'#f5e0c0', muted:'rgba(245,224,192,0.5)',
    bg:'linear-gradient(160deg,#4a2010 0%,#7a3820 20%,#c06030 50%,#e89040 75%,#f0c080 100%)',
    gold:'#f0a030', gold2:'#f5c060', rose:'#e06080', sky:'#8090c0',
    glow:'rgba(240,160,48,0.2)', label:'🌅 Evening',
    bubbleAi:'rgba(60,35,10,0.8)', bubbleUser:'rgba(245,224,192,0.15)',
    headerBg:'rgba(26,15,5,0.9)',
  },
  night: {
    midnight:'#09090f', deep:'#0f0f1e', void:'#13131f', card:'#16162a',
    ...
    gold:'#c9a96e', gold2:'#e8cc9a', rose:'#c97b9a', sky:'#7ba8c9',
    glow:'rgba(201,169,110,0.18)', label:'🌙 Night',
    bubbleAi:'rgba(22,22,42,0.95)', bubbleUser:'rgba(255,255,255,0.06)',
    headerBg:'rgba(9,9,15,0.9)',
  },
};
...
const GlobalStyles = ({ theme = 'night' }) => {
  ...
  <style>{`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .stars-bg { background: ${t.bg} !important; }
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', position: 'relative', zIndex: 1 }}>
      ...
      <div style={{ padding: '52px 20px 16px', borderBottom: '1px solid var(--border)', background: 'rgba(9,9,15,0.85)', backdropFilter: 'blur(12px)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          ...
          <div style={{ fontSize: 11, color: 'var(--muted)', marginTop: 2 }}>Chart-aware · Vedic AI · Gemini</div>
        </div>
...
export default function App() {
  ...
  // Update theme every minute automatically
  useEffect(() => {
